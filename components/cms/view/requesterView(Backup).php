...
<br />
  ...
  <form method="post" action="index.php?components=cms&action=add_request" enctype="multipart/form-data" onsubmit="return validateCMSRequest()" >
		<table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet">
			<tr><td width="50px"></td><td style="vertical-align:middle">Type Of System</td><td style="vertical-align:middle"><select name="system_type" id="system_type" onchange="changeSystemType()"><option value="">-SELECT-</option><option value="1">New System</option><option value="2">Existing System</option></select></td><td width="50px"></td><td style="vertical-align:middle"><div id="div1">Name Of the System</div></td><td>
		...
		?>
			...
			<tr><td width="50px"></td><td style="vertical-align:middle">Required Date</td><td><input type="text" name="cr_rq_date" id="app_date" class="inline_calendar"/><div class="grid_6" id="eventbox"><div class="hidden_calendar"></div></div>

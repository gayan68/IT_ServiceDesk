...
if($_COOKIE['cmsApprover']==md5('Approver'))			print '<li><a href="index.php?components=cms&action=show_approve_list" class="current"><span>Approve Change Request</span></a></li>';
...
<!-- CONTENT START -->
    ...
    <!-- #PORTLETS START -->
<?php
		if($_GET['action']=='show_approve_list')   include_once  'components/cms/view/tpl/approve_list.php';
		if($_GET['action']=='show_approve_cr')   include_once  'components/cms/view/tpl/approve_cr.php';
?>

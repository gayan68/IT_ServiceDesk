...
if($_COOKIE['cmsAnalysis']==md5('Analysis'))			print '<li><a href="index.php?components=cms&action=show_analyse_list" class="current"><span>Analyse Change Request</span></a></li>';
...
<!-- CONTENT START -->
    ...
    <!-- #PORTLETS START -->
<?php
		if($_GET['action']=='show_analyse_list')   include_once  'components/cms/view/tpl/ana_list.php';
		if($_GET['action']=='show_analyse_cr')   include_once  'components/cms/view/tpl/ana_impact.php';
?>

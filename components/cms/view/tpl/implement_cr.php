...
<br />
    <div class="portlet">
		...
		<table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet">
			<tr><td width="50px"></td><td colspan="5">Approval Comment <br /><textarea disabled="disabled" rows="5" style="width:100%"><?php print $approval_comment; ?></textarea></td><td width="50px"></td></tr>
...
<br />
    <div class="portlet">
		...
		<div class="portlet-content nopadding">
  <form method="post" action="index.php?components=cms&action=add_implement" onsubmit="return validateCMSImplement()" >
  <input type="hidden" name="id" value="<?php print $_GET['id']; ?>" />
		<table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet">
			<tr><td width="50px"></td><td style="vertical-align:middle">Implemented Date</td><td><input type="date" name="imp_date" id="app_date" /></td><td width="50px"></td><td style="vertical-align:middle">Implementation Status</td><td>
				<select name="imp_status" id="imp_status">
					<option value="">-SELECT-</option>
					<option value="6">Successful</option>
					<option value="5">Unsuccessful</option>
				</select>
			</td><td width="50px"></td></tr>
			<tr><td width="50px"></td><td colspan="5">Comments<br /><textarea name="imp_comm" id="imp_comm" rows="5" style="width:100%"></textarea></td><td width="50px"></td></tr>
			<tr><td width="50px"></td><td colspan="5" align="center"><input type="submit" value="Submit" style="height:40px; width:200px" /></td><td width="50px"></td></tr>
		</table>
	</form>	
		</div>
      </div>

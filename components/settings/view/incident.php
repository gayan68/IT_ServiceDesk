...
<!-- CONTENT START -->
    ...
    <!--  TITLE END  -->    
<?php
		if($_GET['action']=='incident_general') include_once  'components/settings/view/tpl/incident_general.php';
		if($_GET['action']=='incident_user') include_once  'components/settings/view/tpl/incident_user.php';
?>

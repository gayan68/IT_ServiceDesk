...
<!-- CONTENT START -->
    ...
    <!--  TITLE END  -->    
<?php
		if($_GET['action']=='cms_general') include_once  'components/settings/view/tpl/cms_general.php';
		if($_GET['action']=='cms_user') include_once  'components/settings/view/tpl/cms_user.php';
?>

...
if($_COOKIE['checklist']==md5('Approver'))		print '<li><a href="index.php?components=checklist&action=list_checklist"><span>Approve Checklist</span></a></li>';
                      							print '<li><a href="index.php?components=checklist&action=list_checklist2" class="current"><span>View Checklists</span></a></li>';
...
<tr><td align="center"><a target="_blank" href="index.php?components=checklist&action=print_checklist&id=<?php print $_GET['id']; ?>" ><img border="0" src="images/print.jpg" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="DeleteChecklist(<?php print $_GET['id']; ?>)" ><img border="0" src="images/icons/action_delete.gif" title="Delete Checklist" /></a></td></tr>
</table>
